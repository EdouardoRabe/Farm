   ...
   <body>
      ...
      <svg class="login__blob" viewBox="0 0 566 840" xmlns="http://www.w3.org/2000/svg">
         ...
         <g mask="url(#mask0)">
            ...
            <image class="login__img" href="assets/img/mouton.jpeg"/>
         </g>
      </svg>      
               ...
               <form action="checkLogin" class="login__form" method="post">
                  <div class="login__content grid">
                     <div class="login__box">
                        <input name="email" type="email" id="email" required placeholder=" " class="login__input" value="rakoto.andrianina@example.com">
